...
public class DummySongGenerator {
    ...
    public static void main(String[] args) {
         ...
         * 
         * "99 bottles of lemoniade on the wall, 99 bottles of lemoniade, ya’ take one down, ya’
         * pass it around, 98 bottles of lemoniade on the wall." Subsequent verses are
         * identical except that the number of bottles gets smaller by one in each
         * verse, until the last verse:
         * 
         * "No bottles of lemoniade on the wall, no bottles of lemoniade, ya’ can’t take one down,
         * ya’ can’t pass it around, ’cause there are no more bottles of lemoniade on the
         * wall!" And then the song (finally) ends.
         * 
         * Write a program that displays the entire lyrics of “99 Bottles of lemoniade”. Your
        ...
        String[] songLines = {
            " bottles of lemoniade on the wall",
            " bottles of lemoniade",
